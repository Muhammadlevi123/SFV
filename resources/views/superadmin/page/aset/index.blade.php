                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-sm-flex d-block align-items-center justify-content-between">
                                    <div class=" m-0">
                                        <h5 class="card-title text-start fw-semibold">Tabel Aset SFV <ds id="yeart">
                                            </ds>
                                        </h5>
                                    </div>
                                    <div>
                                            ...
                                            <div class="modal-dialog modal-xl " role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="form-container">
                                                        <form action="{{ route('superadmin.aset.store') }}" method="POST">
                                                            @csrf
                                                            <div class="form-content">
                                                                ...
                                                                <div class="label-flex mb-3">
                                                                    <label for="nama_aset" class="form-label">Nama
                                                                        Aset</label>
                                                                    <input type="text" class="form-control"
                                                                        id="nama_aset" name="nama_aset" value="">
                                                                </div>
                                                                <div class="label-flex mb-3">
                                                                    <label for="luas_aset" class="form-label">Luas</label>
                                                                    <input type="number" class="form-control"
                                                                        id="luas_aset" name="luas_aset" value="">
                                                                </div>
                                                                <div class="label-flex mb-3">
                                                                    <label for="penggunaan_aset"
                                                                        class="form-label">Penggunaan</label>
                                                                    <input type="number" class="form-control"
                                                                        id="penggunaan_aset" name="penggunaan_aset"
                                                                        value="">
                                                                </div>
                                                                <div class="label-flex mb-3">
                                                        ...
                                                        <div class="modal fade" id="modalId{{ $i->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content p-3">
                                                                    <form action="{{ route('superadmin.aset.delete', $i->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <h6>Apakah kamu yakin ingin menghapus data ini?
                                                                            </h6>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                        ...
                                                        <div class="modal fade" id="modalId-edit{{ $i->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-xl " role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="form-container">
                                                                        <form
                                                                            action="{{ route('superadmin.aset.update', $i->id) }}}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('PUT')
                                                                            <div class="form-content">
                                                                            <div class="label-flex mb-3">
                                                                                ...
                                                                                <div class="label-flex mb-3">
                                                                                    <label for="luas_aset"
                                                                                        class="form-label">Luas
                                                                                        </label>
                                                                                    <input type="number"
                                                                                        class="form-control"
                                                                                        id="luas_aset" name="luas_aset"
                                                                                        value="{{ $i->luas_aset }}">
                                                                                </div>
                                                                                <div class="label-flex mb-3">
                                                                                    <label for="penggunaan_aset"
