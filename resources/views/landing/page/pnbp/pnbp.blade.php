        ...
        <section id="blog" class="blog">
            <div class="container-fluid" data-aos="fade-up">
                <div class="row g-5">
                            ...
                            <form action=""> 
                                <div class="sidebar-item search-form m-0">
                                    ...
                                    <select class="form-control choices-sfv">
                                        ...
                                        <option value="-">UPT Gondol</option>
                                        <option value="-">Desa Bangsring</option>
                                        <option value="-">Desa Kawali</option>
                                    </select>
                    ...
                    <div class="col-lg-9">
                        <h4 class="mb-3">SFV : Semua Data UPT dan Desa | (2020 - 2023)</h4>
...
@section('script')
    ...
    <script>
        ...
        var options3 = {
            series: [{
                name: "STOCK ABC",
                data: ['110000000', '40000000', '65000000', '98000000', '74000000']
            }],
            chart: {
                type: 'area',
                width: '100%',
